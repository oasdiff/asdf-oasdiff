...
# NOTE: You might want to remove this if oasdiff is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if oasdiff has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert oasdiff executable exists.
		local tool_cmd
